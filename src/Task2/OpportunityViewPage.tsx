...
import RecommendedChart from "./components/RecommendedCharts";
import DetailedOverview from "./components/DetailedOverView";

const OpportunityViewPage = () => {
  return (
    <div title="FE OverView Task Test - Opportunity Application View">
      <div className="w-[1440px] h-full flex flex-col items-start justify-start gap-6 py-8 px-6  overflow-x-hidden">
